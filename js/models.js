...
class StoryList {
  ...
  //  question here bout tokens 
    ...
    // unshift puts story at begining of list
    this.stories.unshift(story);
    //question here why twice?
  ...
  async removeStory(user, storyId) {
    // where do we find this? our server or api?
    const token = user.loginToken;
    await axios({
    ...
    // creates new stories list with out the storyId that we are removing
    this.stories = this.stories.filter(story => story.storyId !== storyId);

    // do the same thing for the user's list of stories & their favorites
    // question here not sure what this is doing
...
class User {
  ...
  constructor({
    ...
    //again this token I dont understand
  ...
  async removeFavorite(story) {
    //filter stories and map them all except the one you want to remove
